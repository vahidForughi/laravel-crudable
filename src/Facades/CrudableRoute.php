 ...
 * @method static void apiCruds(array $resources, array $options = [])
 * @method static \Illuminate\Routing\PendingResourceRegistration apiResource(string $name, string $controller = \Generaltools\Crudable\Controllers\EntityController::class, array $options = [])
 * @method static \Illuminate\Routing\PendingResourceRegistration apiCrud(string $name, string $controller, array $options = [])
 ...
 */
class CrudableRoute extends Facade
{
